...
// Forward declaration for challenge page
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF171A34),
      ),
      backgroundColor: const Color(0xFF171A34),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Light blue shadow line
            Container(
              height: 3,
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    const Color(0xFF2D6BFF).withValues(alpha: 0),
                    const Color(0xFF2D6BFF).withValues(alpha: 0.6),
                    const Color(0xFF2D6BFF).withValues(alpha: 0),
                  ],
                ),
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFF2D6BFF).withValues(alpha: 0.4),
                    blurRadius: 8,
                    spreadRadius: 2,
                  )
                ],
...
class _LevelNode extends StatelessWidget {
  ...
  Widget _nodeIcon() {
    ...
    if (level.unlocked) {
      return const Icon(Icons.star_rounded, color: Colors.white, size: 32);
    }
